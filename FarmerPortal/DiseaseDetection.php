...
<body>
     ...
     <body>
          ...
          <div style="display:block;">
               ...
               <div class=content_item><label style="font-size :30px; text-shadow: 1px 1px 1px gray;"><b>Disease Detection</b></label></div>
               <br>
          </div>
          ...
          <div class="container">
            <form class="" action="index.html" method="post">
              <div class="form-group row">
                <label for="verif" class="col-md-4 col-form-label text-md-right"><i class="fas fa-pencil-alt mr-2"></i><b>Please Upload Image of a Leaf from the Plant to be checked</b></label>
                <br>
                <div class="col-md-6">
                  <input id="verif"  type="file" name="verif" required>
                </div>
              </div>
            </form>
          </div>
