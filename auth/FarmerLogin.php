						...
						<div class="card-body border border-dark">
							<form name="my-form" action="FarmerLogin.php" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" id="phone_number" class="form-control border border-dark" name="phonenumber" placeholder="Phone Number" >
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input id="p1" class="form-control border border-dark" type="password" name="password" placeholder="Password" >
									</div>
								</div>
								...
								<div class="col-md-6 offset-md-4">
									...
									<button class="btn " style="background-color:#292b2c;color:goldenrod" onclick="location.href='../index.html';" type="button">
												Home
									</button>
								</div>
								<br>
